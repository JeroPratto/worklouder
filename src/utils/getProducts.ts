	...
	const products: Product[] = [
		{
			...
			footer: NomadeFooter,
			carouselImages: [
				'/product-page/nomade/carousel/Nomad-Atom.jpg',
				'/product-page/nomade/carousel/Nomad-Atom-4.102-scaled.jpg',
				'/product-page/nomade/carousel/Nomad-Atom-5.103-scaled.jpg',
				'/product-page/nomade/carousel/Nomad-Atom-6.104-scaled.jpg',
				'/product-page/nomade/carousel/Nomad-Purple-1.109-2048x1365.jpg',
				'/product-page/nomade/carousel/Nomad-Purple-4.112-2048x1365.jpg',
				'/product-page/nomade/carousel/Nomad-Purple-5.114-2048x1365.jpg',
				'/product-page/nomade/carousel/Nomad-Graphite-1.117-2048x1365.jpg',
				'/product-page/nomade/carousel/Nomad-Chalk-1.131-2048x1365.jpg',
			],
			name: 'Nomad[E]',
			stock: {
				preOrder: true,
		...
		},
		{
			...
			carouselImages: [
				'/product-page/creator-micro/Micro-RGB-1-2048x1365.png',
				'/product-page/creator-micro/Micro-3-2048x1365.png',
				'/product-page/creator-micro/Micro-3-2048x13652.png',
				'/product-page/creator-micro/Micro-5-2048x1365.png',
				'/product-page/creator-micro/Micro-4-2048x1365.png',
			],
			name: 'Creator Micro',
			stock: {
				preOrder: false,
		...
		},
		{
			...
			carouselImages: [
				'/product-page/creator-board/R4-CB-1-rgb-2048x1365.png',
				'/product-page/creator-board/R4-CB-1-2048x1365.png',
				'/product-page/creator-board/R4-CB-6-2048x1365.png',
				'/product-page/creator-board/R4-CB-5-2048x1365.png',
			],
		...
		},
		{
			...
			carouselImages: [
				'/product-page/creator-board-xl/XL-RGB-Std-2048x1365.png',
				'/product-page/creator-board-xl/XL-Std-4-2048x1365.png',
				'/product-page/creator-board-xl/XL-Std-5-2048x1365.png',
			],
